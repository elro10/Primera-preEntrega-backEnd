...
class ProductManager {
  ...
  async addProduct(
    ...
    if (
      ...
      throw new Error (`falta informacion para este item, recuerde agregar todos los campos:  title || description || code || price || status || stock ||category || thumbnail`);
    }
  ...
  async getProductByCode(code) {
    ...
    if (chkProductId) {
      ...
      console.log(
        `producto con el codigo ${code} encontrado, se mostrara a continuacion`
      );
